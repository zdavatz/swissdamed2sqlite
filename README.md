...
- **MiGeL** — matches UDI devices against MiGeL (Mittel- und Gegenständeliste) codes (~15,700 of ~178,400 rows, category-level precision ~99.9%) in two layers:
