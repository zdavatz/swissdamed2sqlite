...
- **MiGeL** — matches UDI devices against MiGeL (Mittel- und Gegenständeliste) codes (~15,900 of ~223,100 rows, category-level precision ~99.9%) in two layers:
