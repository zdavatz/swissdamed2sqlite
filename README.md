...
- **MiGeL** — matches UDI devices against MiGeL (Mittel- und Gegenständeliste) codes (~15,600 of ~181,100 rows, category-level precision ~99.9%) in two layers:
