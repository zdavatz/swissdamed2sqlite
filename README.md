...
- **MiGeL** — matches UDI devices against MiGeL (Mittel- und Gegenständeliste) codes (~16,000 of ~233,000 rows, category-level precision ~99.9%) in two layers:
